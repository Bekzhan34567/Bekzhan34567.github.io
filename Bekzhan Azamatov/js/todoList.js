...
const fetchData = async () => {
    try {                            
        const response = await fetch(`https://65748480b2fbb8f6509c4a34.mockapi.io/api/a/users/${userId}/tasks`)
...
const getFilteredTasks = async (completed) => {
    try {                             
        const response = await fetch(`https://65748480b2fbb8f6509c4a34.mockapi.io/api/a/users/${userId}/tasks/${completed}`)
...
const deleteTask = async (id) => {
    try {
        const response = await fetch(`https://65748480b2fbb8f6509c4a34.mockapi.io/api/a/users/${userId}/tasks/${id}`, {method: "DELETE"})
...
const checkTask = async (id, completed) => {
    ...
    try {
        const response = await fetch(`https://65748480b2fbb8f6509c4a34.mockapi.io/api/a/users/${userId}/tasks/${id}`, options)
        console.log(response)
    } catch (e) {
        console.log(e)
    }
...
const postTask = async (title, desc) => {
    ...
    try {
        const response = await fetch(`https://65748480b2fbb8f6509c4a34.mockapi.io/api/a/users/${userId}/tasks/`, options)
        return await response.json()
    } catch (e) {
        console.log(e)
    }
